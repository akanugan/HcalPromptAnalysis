...
{ 
   ...
   TTreeReaderArray<int> SimTracksEta = {fReader, "SimHitsEta"};
   TTreeReaderArray<int> SimHitsPhi = {fReader, "SimHitsPhi"};
   TTreeReaderArray<int> SimHitsPt = {fReader, "SimHitsPt"};
...
// Main function
//
void ana_PFStudy_v1(TString rootfile="relval_SinglePi_2018_E50HCAL.root",TString outfile="pfstudy_histograms.root",int maxevents=-1)
{
