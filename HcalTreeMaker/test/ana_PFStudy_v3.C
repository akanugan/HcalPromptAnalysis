...
/*
   ...
   */
   ...
   while (fReader.Next()) {
	 ...
	 if (v_temp.DeltaR(v_gen) < dR && SimTracksPt.GetSize() == 2){ 
...
// Main function
//
void ana_PFStudy_v3(TString rootfile="relval_SinglePi_2018_E50HCAL_full.root",TString outfile="pfstudy_histograms1.root",int maxevents=-1)
{
