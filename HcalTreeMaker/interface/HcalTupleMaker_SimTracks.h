#ifndef HcalTupleMaker_SimTracks_h
#define HcalTupleMaker_SimTracks_h
...
// Class definition
// 
class HcalTupleMaker_SimTracks : public  edm::EDProducer {
 protected:
  ...
  void produce( edm::Event & iEvent, const edm::EventSetup & iSetup ) { 
    ...
    if (debug) std::cout << "HcalTupleMaker_SimTracks: produce starts" << std::endl;
 ...
 HcalTupleMaker_SimTracks(const edm::ParameterSet& iConfig) :
